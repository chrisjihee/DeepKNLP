"""Step 2 answer blocks for task4B-qa-gen/train_qa_seq2seq.py."""
...
def complete_step2_build_trainer(model, training_args, train_dataset, eval_dataset, eval_examples, tokenizer, data_collator, compute_metrics, post_processing_function):
...
def complete_step2_run_eval(trainer, training_args, eval_dataset, data_args, max_length, num_beams):
