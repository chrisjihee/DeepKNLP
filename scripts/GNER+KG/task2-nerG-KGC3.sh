...
#python task2-nerG.py train --run_version LLaMA-8B-KGC3 --pretrained meta-llama/Llama-3.1-8B --study_file data/gner/KG-generation-YAGO3-53220@3.jsonl
python task2-nerG.py train --run_version Qwen-3B-KGC3 --pretrained Qwen/Qwen2.5-3B --study_file data/gner/KG-generation-YAGO3-53220@3.jsonl
