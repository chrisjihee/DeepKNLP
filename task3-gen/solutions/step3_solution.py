"""Step 3 answer blocks for task3-gen/run_gen.py."""


def complete_step3_load_finetuned_components(args, device):
...
def complete_step3_build_inference_fn(model, tokenizer):
    def inference_fn(
        prompt,
        min_length=10,
        max_length=20,
