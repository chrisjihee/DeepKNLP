...
def main(
        ...
        per_device_train_batch_size: Annotated[int, typer.Option("--per_device_train_batch_size")] = 25,
        ...
        eval_epochs: Annotated[float, typer.Option("--eval_epochs")] = 0.1,
        ...
        eval_delay: Annotated[float, typer.Option("--eval_delay")] = 6.0,
