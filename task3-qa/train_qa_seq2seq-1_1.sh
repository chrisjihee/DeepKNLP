CUDA_VISIBLE_DEVICES=0 python task3-qa/train_qa_seq2seq.py \
  ...
  --output_dir output/korquad/train_qa_seq2seq-by-ket5-base \
...
python task3-qa/evaluate-KorQuAD-v1.py \
       ...
       output/korquad/train_qa_seq2seq-by-ket5-base/eval_predictions.json

# {"exact_match": 1.6453065465881538, "f1": 30.642120448946745}
